...
| [references/api.md](references/api.md) | Calling `/api/library-lint` or using the CLI against a live account |
...
- `1` — failed to load input / API / invalid snapshot
